...
from google.cloud import speech  ###sudo -H python3 -m pip install google-cloud-speech
...
#StreamingRecognize(CallSettings.FromCallTiming(CallTiming.FromExpiration(Expiration.None)))
