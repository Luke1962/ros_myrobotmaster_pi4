...
class DialogflowClient(object):
   ...
   # ========================================= #
    ...
    def _generator(self):
        ...
        # vedi https://cloud.google.com/dialogflow/docs/reference/rpc/google.cloud.dialogflow.v2#queryinput
        ...
        # chiama Dialogflow con i vari parametri appena preparati
        #vedi https://cloud.google.com/dialogflow/docs/reference/rpc/google.cloud.dialogflow.v2#streamingdetectintentrequest
