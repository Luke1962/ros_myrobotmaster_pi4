...
sys.path.append('/home/luca/ros/src/dialogflow_ros/src/dialogflow_ros')#per importare utils
sys.path.append('/home/luca/ros/src/dialogflow_ros/src/dialogflow_ros/utils')#per importare utils

#sys.path.append('/usr/local/lib/python3.6/dist-packages/') # dove la procedura di setup ha installato snowboy-1.3.0-py3.6.egg
